...
export class CreateUserComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    ...
    this.canEditUser = this.currentUser.role == Role.Admin || this.currentUser.role == Role.SuperAdmin;
  ...
  initForm(currentUser: any = null) {
    ...
    this.createForm = this.formBuilder.group({
      ...
      username: [{ value: currentUser ? currentUser.userName : '', disabled : currentUser != null }, [Validators.required]],
      password: [ currentUser ? currentUser.password : '', [Validators.required]],
      confirmPassword: [ currentUser ? currentUser.password : '', [Validators.required]],
      ...
      balance: [ currentUser ? currentUser.balance : '', []],
  ...
  gotoListUser() {
    this.router.navigate(['/manager/list-user']);
  }
  ...
  createUser() {
    ...
    userDto.balance = parseFloat(this.createForm.controls.balance.value);
    userDto.gender = this.createForm.controls.genderId.value;
    userDto.role = this.createForm.controls.roleId.value;
    userDto.level = parseInt(this.createForm.controls.levelId.value);
