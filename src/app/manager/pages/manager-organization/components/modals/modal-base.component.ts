...
import {
	CapacityGreaterThanAllowedLoadValidator, ManagerOrganizationService, MessageService
} from '@flex-team/core';
import { Observable } from 'rxjs';

@Component({
	selector: 'manager-organization-modal-base',
	template: '',
})
export abstract class ManagerOrganizationModalBaseComponent implements OnInit {
