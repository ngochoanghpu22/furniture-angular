...
import { UsersPickedTaskComponent } from './users-picked-task.component';


const routes: Routes = [
  {
    path: '', 
    component: UsersPickedTaskComponent,
  },
 
];

const components = [
    UsersPickedTaskComponent,
];
...
export class UsersPickedTaskModule { }
